(ns vinculum.server
  (:require [clojure.java.io :as io]
            [vinculum.dev :refer [is-dev? inject-devmode-html browser-repl start-figwheel]]
...
;;            [ring.middleware.defaults :refer [wrap-defaults api-defaults]]
            ...
            [compojure.core :refer [defroutes ANY GET routes]]
...
;; under the given key.
;; FIXME: should also check for missing keys, invalid values etc, see
;; https://gist.github.com/iperdomo/8019012
;; malformed? is for "does this data contain the correct entries?"
;; processable? is for "does this data fulfill preconditions"
...
;; Fixme: handlers are *messy*!
(def handler
  (wrap-cors (-> vinculum-app
                 wrap-params)
